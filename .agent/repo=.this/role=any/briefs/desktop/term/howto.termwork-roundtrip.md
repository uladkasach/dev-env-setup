...
the kitty window is visible on the human's screen: commands as typed, output as it appears,
and the live processes. the agent drives it while the human observes.
