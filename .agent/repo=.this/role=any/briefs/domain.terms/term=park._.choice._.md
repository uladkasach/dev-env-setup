...
- src/brains.auth.sh   # `_brains_auth_park_read`  — read the live token out, write nowhere
- src/brains.auth.sh   # `_brains_auth_park_file`  — file it into the keyrack
- src/brains.auth.sh   # `_brains_auth_park_or_strand` — the failure fork
